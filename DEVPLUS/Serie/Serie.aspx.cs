...
namespace DEVPLUS.Serie
{
    public partial class Serie : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var comando = new MySqlCommand($"SELECT * FROM serie_", connection);
                ...
                lista_videos.InnerHtml += $@"
                         <div class=""col-sm-3"">
							<div class=""thumb-wrapper"">
								...
								<div class=""img-box"">
									<img src=""../Upload/serie/{reader.GetString("genero")}/{reader.GetString("titulo")}/{reader.GetString("titulo")}.jpg"" class=""img-responsive"" alt="""">									
								</div>
