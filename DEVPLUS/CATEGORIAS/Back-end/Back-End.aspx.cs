...
namespace DEVPLUS.CATEGORIAS.Back_end
{
    public partial class Back_End : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var comando = new MySqlCommand($"SELECT * FROM `video_` WHERE `genero`='back-end'", connection);
            ...
            Carousel.InnerHtml = "";
            var command1 = new MySqlCommand($"SELECT * FROM `serie_` WHERE `genero`='back-end'", connection);
