...
namespace DEVPLUS.CATEGORIAS.Banco_de_dados
{
    public partial class Banco_de_Dados : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var comando = new MySqlCommand($"SELECT * FROM `video_` WHERE `genero`='banco-de-dados'", connection);
            ...
            Carousel.InnerHtml = "";
            var command1 = new MySqlCommand($"SELECT * FROM `serie_` WHERE `genero`='banco-de-dados'", connection);
