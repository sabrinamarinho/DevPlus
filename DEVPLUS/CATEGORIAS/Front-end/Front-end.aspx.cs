...
namespace DEVPLUS.CATEGORIAS.Front_end
{
    public partial class Front_end : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var comando = new MySqlCommand($"SELECT * FROM `video_` WHERE `genero`='front-end'", connection);
            ...
            Carousel.InnerHtml = "";
            var command1 = new MySqlCommand($"SELECT * FROM `serie_` WHERE `genero`='front-end'", connection);
