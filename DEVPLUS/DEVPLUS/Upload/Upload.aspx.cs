        ...
        protected void UpSerie_Click(object sender, EventArgs e)
        {
            ...
            if (listGen.Value == "Back-End")
            {
                ...
                if (FileImg.HasFile)
                {
                    ...
                    string ciname = @"C:\Users\ALUNO\Desktop\Pedro\DevPlus\DEVPLUS\Upload\serie\back-end\" + txtTitulo.Value + @"\" + txtTitulo + ".jpg";
            ...
            if (listGen.Value == "Front-End")
            {
                ...
                if (FileImg.HasFile)
                {
                    ...
                    string ciname = @"C:\Users\ALUNO\Desktop\Pedro\DevPlus\DEVPLUS\Upload\serie\front-end\" + txtTitulo.Value + @"\" + "Capa" + ".jpg";
                    System.IO.File.Move(cname, ciname);
                }
                else
                {
            ...
            if ( listGen.Value == "Automação Python")
            {
                ...
                if (FileImg.HasFile) {
                    ...
                    string ciname = @"C:\Users\ALUNO\Desktop\Pedro\DevPlus\DEVPLUS\Upload\serie\automacao\" + txtTitulo.Value + @"\" + "Capa" + ".jpg";
                    System.IO.File.Move(cname, ciname);
                }
                else
                {
            ...
            if ( listGen.Value == "Banco De Dados")
            {
                ...
                if (FileImg.HasFile)
                {
                    ...
                    string ciname = @"C:\Users\ALUNO\Desktop\Pedro\DevPlus\DEVPLUS\Upload\serie\banco-de-dados\" + txtTitulo.Value + @"\" + "Capa" + ".jpg";
                    System.IO.File.Move(cname, ciname);
                }
                else
                {
